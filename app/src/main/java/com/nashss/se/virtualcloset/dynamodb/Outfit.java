...
public class Outfit {
    ...
    @DynamoDBIndexHashKey(attributeName = "customerId", globalSecondaryIndexName = "outfit-worncount-index")
    ...
    @DynamoDBIndexRangeKey(attributeName = "wornCount", globalSecondaryIndexName = "outfit-worncount-index")
